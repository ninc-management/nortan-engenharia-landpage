...
var IdealImageSlider = (function () {
  ...
  var _setContainerHeight = function (slider, shouldAnimate) {
    ...
    newHeight = Math.round(newHeight + 200);
    if (newHeight === currentHeight) {
      return;
    }

    // Fix slider position
    var navHeight = document.getElementsByClassName('masthead')[0].offsetHeight;
    slider._attributes.container.style.left = '0px';
    slider._attributes.container.style.top = navHeight + 'px';
    document.getElementsByClassName('feature__wrapper')[0].style.marginTop = newHeight + 'px';
